    ...
    protected override async IAsyncEnumerable<Product> GenerateCoreAsync()
    {
        ...
        var mappedBatches = MapParallel(
            ...
            async _ =>
            {
                ...
                Images is matching the product name, but with a .png extension.
                
                The result should be JSON form {{ "products": [{{ "id": "guid", "name": "string", "description": "string", "image": "string", "price": 123.45 }}, ...] }}.";
                """;
