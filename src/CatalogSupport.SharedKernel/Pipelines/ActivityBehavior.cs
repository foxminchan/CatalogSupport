...
using CatalogSupport.SharedKernel.ActivityScope;
using CatalogSupport.SharedKernel.Command;
using CatalogSupport.SharedKernel.OpenTelemetry;
using CatalogSupport.SharedKernel.Query;
using MediatR;
using Microsoft.Extensions.Logging;

namespace CatalogSupport.SharedKernel.Pipelines;
